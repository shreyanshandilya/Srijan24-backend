...
exports.otp=(name,otp)=>{
    ...
    const response = {
        body: {
          name: name,
          intro: "Thanks for being a part of Srijan",
          action:[
            {
          ...
          {
            instructions: "Note: This OTP is valid for only 10 mins , after 10 mins if not logged in then generate new OTP ",
          }
        ],
